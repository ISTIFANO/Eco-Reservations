  ...
  <div class="flex min-h-screen">
    <div class="fixed w-64 h-full bg-white shadow-lg">
      ...
      <nav class="mt-6 px-4">
        ...
        <a href="/mesreservation" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg mb-2 transition-colors">
        <i class="bi bi-star mr-3 text-lg"></i>
        <span>Mes Reservation</span>
        </a>
        
        <a href="/Profile" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg mb-2 transition-colors">
